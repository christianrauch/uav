  ...
  const hardware_interface::HardwareComponentInterfaceParams & params)
{
  ...
  static constexpr std::string_view calibration_file_parameter_name = "calibration_file";
  if (params.hardware_info.hardware_parameters.contains(
        std::string{calibration_file_parameter_name}))
  {
    const YAML::Node calibration = YAML::LoadFile(
      params.hardware_info.hardware_parameters.at(std::string{calibration_file_parameter_name}));
