...
controller_interface::CallbackReturn RCBroadcaster::on_init()
{
...
RCBroadcaster::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
RCBroadcaster::state_interface_configuration() const
{
...
PLUGINLIB_EXPORT_CLASS(
  rc_broadcaster::RCBroadcaster, controller_interface::ControllerInterface)
