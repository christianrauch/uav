...
public:
    ...
    const rclcpp::Time & time, const rclcpp::Duration & period) override
  {
    ...
    msg[0].error = roll_err;
    msg[1].error = pitch_err;
    msg[2].error = yaw_rate_err;
    msg[0].error_dot = wx;
    msg[1].error_dot = wy;
    msg[2].error_dot = 0;
    ...
    // P gains
    msg[0].p_gain = gain_roll_p;
    msg[1].p_gain = gain_pitch_p;
    msg[2].p_gain = gain_yaw_p;
    // D gains
    msg[0].d_gain = gain_roll_d;
    msg[1].d_gain = gain_pitch_d;
    msg[2].d_gain = 0;
    // no I gains
    msg[0].i_gain = msg[1].i_gain = msg[2].i_gain = 0;
